{
  inputs =
    let
      version = "1.8.2";
system = "x86_64-linux";
devenv_root = "/home/nx/code/Künstlerschmuck/EasyArtDB";
devenv_dotfile = "/home/nx/code/Künstlerschmuck/EasyArtDB/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-854cad4";
